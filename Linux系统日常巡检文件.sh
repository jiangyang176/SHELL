...
# @Last Modified by:   gaochao 
# @Last Modified time: 2021-10-31 11:06:31
# @E-mail: 1428347992@qq.142
#!/bin/bash
#主机信息每日巡检
...
echo -e "`date "+%Y-%m-%d %H:%M:%S"` 阿里云PHP企业平台巡检报告"  | mail -a $RESULTFILE -s "阿里云PHP企业平台巡检报告" 1428347992@qq.com
